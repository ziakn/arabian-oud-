                                                            ...
                                                            <div class="f-fix">
                                                                ...
                                                                <div class="actions">
                                                                    <ul class="add-to-links ">
                                                                        ...
                                                                        <li><a href="{{URL::route('news_lettre_view',$data->id)}}" title=" blog" class="link-learn"><button type="button" class="button btn-cart" ><span><span>Learn more</span></span></button></a></li>
